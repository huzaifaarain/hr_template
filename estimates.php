                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped custom-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="admin/hr/accounts/estimate/estimate_view.php">EST-0001</a></td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="admin/hr/accounts/estimate/estimate_edit.php"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                        ...
                                        <tr>
                                            <td><a href="admin/hr/accounts/estimate/estimate_view.php">EST-0002</a></td>
                                        ...
                                        <tr>
                                            <td><a href="admin/hr/accounts/estimate/estimate_view.php">EST-0003</a></td>
                                            <td>Cream Inc</td>
                                            <td>11 Mar 2019</td>
                                            <td>17 Mar 2019</td>
                                            <td>$2099</td>
                                        ...
                                        <tr>
                                            <td><a href="admin/hr/accounts/estimate/estimate_view.php">EST-0004</a></td>
