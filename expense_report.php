						...
						<table class="table table-striped custom-table mb-0 datatable">
							...
							<tbody>
								<tr>
									...
									<td>5 Jan 2019</td>
									<td>
										<a href="admin/hr/reports/profile.php" class="avatar avatar-xs">
											<img src="assets/img/profiles/avatar-04.jpg" alt="">
										</a>
										<h2><a href="admin/hr/reports/profile.php">Loren Gatlin</a></h2>
									</td>
									<td>$ 1215</td>
									<td>Cash</td>
								...
								<tr>
									...
									<td>
										...
										<h2><a href="admin/hr/reports/profile.php">Tarah Shropshire</a></h2>
									</td>
									<td>$ 1215</td>
									<td>Cheque</td>
									<td class="text-center">
