                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="admin/hr/accounts/expenses/profile.php" class="avatar avatar-xs"><img src="assets/img/profiles/avatar-04.jpg" alt=""></a>
                                            <a href="admin/hr/accounts/expenses/profile.php">Loren Gatlin</a>
                                        </h2>
                                    </td>
                                    <td>$1215</td>
                                    <td>Cash</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="admin/hr/accounts/expenses/profile.php" class="avatar avatar-xs"><img src="assets/img/profiles/avatar-03.jpg" alt=""></a>
                                            <a href="admin/hr/accounts/expenses/profile.php">Tarah Shropshire</a>
                                        </h2>
                                    </td>
                                    <td>$1215</td>
                                    <td>Cheque</td>
