							...
							<div class="table-responsive">
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td><a href="admin/administration/jobs/job_details.php">Web Developer</a></td>
											<td>Development</td>
											<td>3 Mar 2019</td>
											<td>31 May 2019</td>
											...
											<td><a href="admin/administration/jobs/job_applicants.php" class="btn btn-sm btn-primary">3 Candidates</a></td>
											<td class="text-right">
										...
										<tr>
											<td>2</td>
											<td><a href="admin/administration/jobs/job_details.php">Web Designer</a></td>
											<td>Designing</td>
											<td>3 Mar 2019</td>
											<td>31 May 2019</td>
											<td class="text-center">
											...
											<td><a href="admin/administration/jobs/job_applicants.php" class="btn btn-sm btn-primary">2 Candidates</a></td>
											<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
										...
										<tr>
											<td>3</td>
											<td><a href="admin/administration/jobs/job_details.php">Android Developer</a></td>
											<td>Android</td>
											<td>3 Mar 2019</td>
											<td>31 May 2019</td>
											<td class="text-center">
											...
											<td><a href="admin/administration/jobs/job_applicants.php" class="btn btn-sm btn-primary">1 Candidates</a></td>
											<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
