			...
			<div class="page-header">
				<div class="row align-items-center">
					...
					<div class="col-auto float-right ml-auto">
						<a href="employee/projects/task_board.php" class="btn btn-white float-right m-r-10" data-toggle="tooltip" title="Task Board"><i class="fa fa-bars"></i></a>
					</div>
				</div>
			</div>
			<!-- /Page Header -->
							...
							<table class="table table-striped table-border">
								<tbody>
									...
									<tr>
										...
										<td class="text-right">
											<div class="btn-group">
												<a href="#" class="badge badge-danger">Highest </a>
											</div>
										</td>
									</tr>
									<tr>
