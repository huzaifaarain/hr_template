        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <div class="view-icons">
                            <a href="employee/projects/projects.php" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                            <a href="employee/projects/projects_list.php" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="project-title"><a href="employee/projects/project_view.php">Office Management</a></h4>
                ...
                <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="project-title"><a href="employee/projects/project_view.php">Project Management</a></h4>
                            <small class="block text-ellipsis m-b-15">
                ...
                <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="project-title"><a href="employee/projects/project_view.php">Video Calling App</a></h4>
                            <small class="block text-ellipsis m-b-15">
                ...
                <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="project-title"><a href="employee/projects/project_view.php">Hospital Administration</a></h4>
                            <small class="block text-ellipsis m-b-15">
