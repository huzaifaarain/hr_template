...
<html lang="en">
    <head><base href="../../">
        ...
        <!-- Page Header PHP -->
		<?php include '../../layout/header_noaside_wo.php'; ?>
        <!-- End::Page Header PHP -->
                ...
                <div class="sidebar-inner slimscroll">
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li> 
                                <a href="employee/projects/tasks.php">Project Management</a>
                            </li>
                            <li class="active"> 
                                <a href="employee/projects/tasks.php">Hospital Administration</a>
                            </li>
                            <li> 
                                <a href="employee/projects/tasks.php">Video Calling App</a>
                            </li>
                            <li> 
                                <a href="employee/projects/tasks.php">Office Management</a>
                            </li>
                        </ul>
                    </div>
                </div>
