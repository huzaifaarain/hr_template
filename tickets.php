                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><a href="employee/tickets/ticket_view.php">#TKT-0001</a></td>
                                    <td>Laptop Issue</td>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a class="avatar avatar-xs" href="employee/tickets/profile.php"><img alt="" src="assets/img/profiles/avatar-10.jpg"></a>
                                            <a href="#">John Smith</a>
                                        </h2>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown action-label">
                                            <a class="btn btn-white btn-sm btn-rounded" href="#"><i class="fa fa-dot-circle-o text-danger"></i> High </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a class="avatar avatar-xs" href="employee/tickets/profile.php"><img alt="" src="assets/img/profiles/avatar-08.jpg"></a>
                                    ...
                                    <td>
                                        <div class="dropdown action-label">
                                            <a class="btn btn-white btn-sm btn-rounded" href="#"><i class="fa fa-dot-circle-o text-warning"></i> Medium </a>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="dropdown action-label">
